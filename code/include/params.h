...
// Dimension of the message vector (without usk) - Originally, 10 attributes were expected from the authorsů
//#define PARAM_M 10

// Dimension of the message vector (without usk) - 1 attribute = 1 credential
#define PARAM_M 1
